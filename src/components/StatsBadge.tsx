...
export default function StatsBadge() {
  ...
  return (
    <div className="fixed left-3 top-3 z-[60] flex items-center gap-2 rounded-full border border-black/15 bg-[#e4e6ea] px-3 py-1.5 text-xs font-mono text-black shadow-sm transition-all duration-300 hover:scale-105 hover:border-black/30">
